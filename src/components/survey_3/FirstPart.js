  ...
  return (
    ...
    >
     ...
     <div style={{width:"100%", height:"100%", position:"absolute", zIndex:-1, backgroundColor:"#606582", opacity:".3"}}>
      ...
      <img style={{width:"90%", objectFit:"contain"}} src="/images/naprosyn_logo.png"/>
        <h1 style={{margin:0, textAlign: "center", fontSize: "20px", color: 'white', fontWeight: "700" }}>WISH FOR BANGLADESH NATIONAL CRICKET TEAM</h1>
      </div>
      <div
        style={{
          width: "90%",
